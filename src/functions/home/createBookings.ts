...
async function createBookings(slot: Date, serviceId: Service["id"] | null | undefined, stripePriceId: Service["stripePriceId"] | null | undefined, userId: string | undefined): Promise<void> {
